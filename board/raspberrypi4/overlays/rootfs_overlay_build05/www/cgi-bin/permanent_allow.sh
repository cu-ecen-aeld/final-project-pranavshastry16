...
.banner { background:#dcfce7; padding:14px; border-radius:8px; margin-bottom:18px; font-size:28px; font-weight:bold; width:100%; }
...
<body>
<div class="banner">Permanently Allowed Devices</div>
